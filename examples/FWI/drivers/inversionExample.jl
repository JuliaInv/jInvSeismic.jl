...
pFor = map(fetch, pForp)
mc, Dc, pInv, Iact, mback, pMis = solveInverseProblem(pForp, Dobs, Wd, Q, SourcesSubIndFWI,
 contDivFWI, nx, nz, mref, Mr, 0.5, 0.035,"ES_FWI.dat", true, plotModelResult);
