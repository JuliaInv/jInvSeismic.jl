function setupJointInversion(m,filenamePrefix::String,plotting::Bool,
		...
		Ainv::AbstractSolver = getMUMPSsolver([],0,0,2), misfun::Function=SSDFun,useFilesForFields::Bool = false,onlyFWI::Bool=true,beta::Float64=1.0)

Q,P,pMisFWIRFs,SourcesSubIndFWI,contDivFWI,Iact,sback,mref,boundsHigh,boundsLow = setupFWI(m,filenamePrefix,plotting,workersFWI,maxBatchSize,Ainv, misfun,useFilesForFields)
